      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            <div className="bg-white h-72 w-full flex items-center justify-center p-4 border-b border-gray-100 select-none">
              <img
                src={singleProduct.image}
                alt={singleProduct.name}
                className="w-[75%] sm:w-[80%] md:w-[85%] h-[75%] sm:h-[80%] md:h-[85%] object-contain mx-auto transition-all duration-300"
                loading="lazy"
              />
            </div>
